...
* EX7) 2차원 "**달팽이**"처럼 빙글빙글 돌때 **"범위체크+visited"**로 간단히 구현 가능하다.
...
```java
// dArr[p.cctv][d] -> 총 cctv5개 가지는 문제
static int[] dArr1 = {0,1,2,3};
static int[][] dArr2 = {{2,0},{3,1}}; // {왼,오}, {위,아}
static int[][] dArr3 = {{3,0},{0,1},{2,1},{2,3}}; // {위,오}, {오,아}, {왼,아}, {왼,위}
static int[][] dArr4 = {{3,0,2},{3,0,1},{0,2,1},{2,3,1}}; // {위,오,왼}, {위,오,아}, {오,왼,아}, {왼,위,아}
static int[][] dArr5 = {{0,1,2,3}}; // {오,아,왼,위}
